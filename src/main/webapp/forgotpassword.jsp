...
<h2 style='color:black;text-align:center;margin-top:90px;'>Forgot password</h2>
...
<p id="ecp" style="font-size:12px;font-weight:540;position:absolute;top:-30px;left:0px;">Enter billno:-</p>
 <input type="text" id="cpass" onblur="passwordcheck();">
...
function updatepass() {
  if(validate() == true && confrim() == true && p == true){
    ...
    var url = "http://localhost:8080/user/changepass/"+npass.value;
...
function passwordcheck()
{
  ...
  var xhtml = new XMLHttpRequest();
  var url = "http://localhost:8080/user/getchange/"+ cpass.value;
